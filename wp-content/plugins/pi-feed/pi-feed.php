...
class pi_feed{
    ...
    private static function render_field_options($text, $name, $fields){
        ...
        ?>
            <tr>
                <td><input <?php if($use) echo 'checked="checked"';?> type="checkbox" name="of_ck_field[]" value="<?=$name?>"></td>
                <td><label><?php echo $text;?>:</label></td>
                <td>
                    <select name="of_<?=$name?>" id="of_<?=$name?>" class="of_select">
                ...
                <td>
                    <div id="of_<?=$name?>_pm" style="<?php if($value != 'post_meta') echo 'display: none;';?>">
                        <input name="of_<?=$name?>_meta_key" type="text" style="width: 150px;" value="<?=$value2?>">
                    </div>
                </td>
            </tr>
        <?php  
