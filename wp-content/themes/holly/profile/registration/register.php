...
<div id="register-page">
    <div class="register-header">
        <h1>JOIN <span class="its_green"><?phpget_bloginfo('name');?></span> on CELEBUZZ </h1>
    ...
    <div id="edit-profile-container-wrap">
        <div id="container">
            ...
            <?php if ( 'request-details' == icep_get_current_signup_step() ) : ?>
                ...
                <?php if ( true ) : ?>
                    <div class="register-section" id="profile-details-section">
                        ...
                        <div class="checkbox">
                            <span class="label"> <input type="checkbox" name="accept_tos" id="accept_tos" value="agreed" <?php $accept_tos_checked ?> />I agree to the Celebuzz <a href="<?phpapply_filters('get-celebuzz-url', '/', '/');?>terms-of-service" target="_blank">Terms Of Service and Privacy Policy</a></span>
            ...
            <?php if ( 'completed-confirmation' == icep_get_current_signup_step() ) : ?>
                ...
                <?php endif; ?>
                    <span class="its_green"><a href="<?phphtmlspecialchars(site_url());?>">Return to <?phpget_bloginfo('name');?></a><span>
