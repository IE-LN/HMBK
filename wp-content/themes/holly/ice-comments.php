                    ...
                    <form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post" id="commentform" class="standard-form">
                        ...
                        <p class="form-textarea">
                            <label for="comment"><?php _e('', 'buddypress'); ?></label>
														...
														<?php endif; ?>
                            <textarea name="comment" id="comment" cols="40" rows="10" tabindex="4"><?phpapply_filters('comment_form_content', '');?></textarea>
                ...
                <?php if (function_exists('ecu_upload_form')): ?>
                    <?php if (is_user_logged_in()): ?>
                        <div id="upload_form_wrapper">
                            ...
                            <?php_e('JPG, PNG, GIF Only. For animated GIFs, paste image link in text box', 'buddypress');?>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
