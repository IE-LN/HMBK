...
<div class="search-results-section results-section news-results-section">
    <h3 class="search-results-section-heading results-section-heading news-results-section-heading">
        ...
        ?>
        <a class="search-results-back-to-all" href="<?phpapply_filters('ice-search-link', '', $args);?>">Back to All Results &raquo;</a>
                ...
                <article id="post-<?php $post->ID ?>" <?php post_class('news-item'); ?>>
                    <header>
                        ...
                        <div class="news-result-info">
                            ...
                            <h2 class="search-entry-title posttitle blackmaroon"><a href="<?php get_permalink() ?>" title="View <?php esc_attr(get_the_title()) ?>"><? the_title() ?></a></h2>
                            <div class="post-meta">
    ...
    <div class="search-results-section-bottom">
        ...
        $args['search_type'] = $block['type'];
        ?>
        <div class="results-more more"><a href="<?phpapply_filters('ice-search-link', '', $args);?>">see all news &raquo;</a></div>
    </div>
